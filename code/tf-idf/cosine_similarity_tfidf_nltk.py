...
def returnListOfFilePaths(folderPath):
    fileInfo = []
    listOfFileNames = [fileName for fileName in listdir(folderPath) if (isfile(join(folderPath, fileName)) and fileName[0] != '.')]
    listOfFilePaths = [join(folderPath, fileName) for fileName in listdir(folderPath) if (isfile(join(folderPath, fileName)) and fileName[0] != '.')]
